...
import ManagerLessonHeader from "../manager/ManagerLesson/ManagerLessonHeader";
import ManagerLessonSiderBar from "../manager/ManagerLesson/ManagerLessonSiderBar";
import ManagerLessonContent from "../manager/ManagerLesson/ManagerLessonContent";
...
const ManagerLesson: React.FC = () => {
    ...
    return (
        <Layout style={{ width: "100%", height: "100vh" }}>
            <ManagerLessonSiderBar collapsed={collapsed} onCollapse={setCollapsed} />
            <Layout>
                <ManagerLessonHeader
                    collapsed={collapsed}
